...
export const FEATURES: Record<FeatureKey, FeatureInfo> = {
  ...
  'geo-monitor':      { key: 'geo-monitor',      label: 'Prompt',                 path: '/dashboard/geo-monitor',       group: 'Actions',      order: 50 },
  'analysis':         { key: 'analysis',         label: 'Analysis',               path: '/dashboard/analysis',          group: 'Actions',      order: 60 },
  'geo-audit':        { key: 'geo-audit',        label: 'Agent Audit',             path: '/dashboard/geo-audit',         group: 'Assistant',    order: 70 },
  ...
  'geo-optimization': { key: 'geo-optimization', label: 'GEO Optimization',       path: '/dashboard/geo-optimization',  group: 'Assistant',    order: 75 },
