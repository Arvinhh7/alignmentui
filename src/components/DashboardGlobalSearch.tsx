...
const MODULE_RESULTS: SearchResult[] = [
  ...
  { id: 'module-ga4', type: 'module', title: 'GA4 Attribution', subtitle: 'AI traffic and revenue attribution', icon: LineChart, disabled: true, badge: 'Coming soon', keywords: ['ga4', 'analytics', 'attribution', 'roi'], score: 0 },
