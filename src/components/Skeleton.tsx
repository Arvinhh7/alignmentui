...
export function KpiCardSkeleton() {
  return (
    <div className="bg-surface rounded-2xl border border-divider-light p-5 shadow-sm">
  ...
  return (
    <div className="max-w-6xl mx-auto px-6 py-8 animate-pulse">
      ...
      <div className="grid grid-cols-1 md:grid-cols-5 gap-4 mb-6">
        <div className="md:col-span-1 bg-surface rounded-2xl border border-divider-light p-5 shadow-sm flex flex-col items-center">
...
export function PromptsTableSkeleton() {
  return (
    <div className="bg-surface rounded-2xl border border-divider-light shadow-sm overflow-hidden">
      <div className="flex items-center justify-between px-6 py-3 border-b border-divider-light">
  ...
  return (
    <div className="max-w-4xl mx-auto px-6 py-8 animate-pulse">
      ...
      <div className="bg-surface rounded-2xl border border-divider-light shadow-sm p-6 mb-6">
        <div className="flex items-center gap-3 mb-5 pb-4 border-b border-divider-light">
          <Skeleton className="w-9 h-9 rounded-xl" />
          <div>
      ...
      <div className="grid grid-cols-2 gap-6">
        {[1,2].map(i => (
          <div key={i} className="bg-surface rounded-2xl border border-divider-light shadow-sm p-6">
