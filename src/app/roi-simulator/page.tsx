      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative max-w-5xl mx-auto px-6 py-20 text-center">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 bg-white/10 backdrop-blur border border-white/20 rounded-full mb-6">
            ...
            <span className="text-sm text-white/90 font-medium">{lang === 'zh' ? 'GEO Pro 托管服务 — 注册免费查看结果' : 'GEO Pro Managed Service — Sign up to unlock results'}</span>
          </div>
            ...
            <div className="p-8 md:p-10">
              <div className="flex items-center justify-center gap-2 mb-8">
                {[
                  ...
                  { n: 3, label: lang === 'zh' ? '查看结果' : 'See Results' },
                ].map((s, i) => (
                ...
                <div className="bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 p-8 md:p-10">
                  ...
                  <div className="grid md:grid-cols-3 gap-5 mb-8">
                    <div className="bg-white/[0.07] backdrop-blur rounded-2xl p-6 text-center border border-white/10">
                      <div className="text-sm text-gray-400 mb-3 font-medium">{r.geoInvestment as string}</div>
                      <div className="text-3xl md:text-4xl font-bold text-gray-200 leading-tight">~{fmtUSD(result.geo_investment)}</div>
                      <div className="text-xs text-gray-500 mt-2">
                        {lang === 'zh' ? '$3,999/月 × 6个月' : '$3,999/mo × 6 months'}
                      </div>
                    </div>
                    ...
                    <div className="bg-gradient-to-br from-red-500/15 to-orange-500/10 backdrop-blur rounded-2xl p-6 text-center border border-red-500/30 ring-1 ring-red-500/10">
                      <div className="text-sm text-gray-300 mb-3 font-medium">{r.roiRange as string}</div>
                      <div className="text-4xl md:text-5xl font-black text-white leading-tight">{result.roi_low}x – {result.roi_high}x</div>
                      <div className="text-xs text-gray-400 mt-2">{lang === 'zh' ? '预估投资回报' : 'estimated return'}</div>
                    </div>
                  </div>

                  {/* Explanation */}
                  <div className="bg-white/[0.04] rounded-xl p-5 border border-white/[0.06]">
                    <p className="text-gray-300 text-sm leading-relaxed">{result.result_explanation}</p>
                  </div>
                </div>
                  ...
                  <div className="bg-white rounded-xl p-6 border border-gray-200 shadow-sm">
                    ...
                    <div className="space-y-3">
                      {[
                        ...
                        <div key={i} className={`flex items-center justify-between py-2 ${i < 3 ? 'border-b border-gray-100' : ''}`}>
