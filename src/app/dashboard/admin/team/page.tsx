...
const PERMISSION_KEYS: { key: string; label: string; group: string }[] = [
  ...
  { key: 'agents',            label: 'AI Agents',         group: 'Action' },
  ...
  { key: 'visibility-proxy',  label: 'Visibility Proxy',  group: 'Proxy' },
  { key: 'geo-optimization',  label: 'GEO Optimization',  group: 'Advanced' },
