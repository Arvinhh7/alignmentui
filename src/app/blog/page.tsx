...
const posts: Post[] = [
  {
    ...
    excerpt: {
      ...
      zh: 'ChatGPT、Perplexity 和 Google AI Mode 已经开始直接回答购物问题。做好 GEO 的 Shopify 店铺会被 AI 推荐，没做的则几乎不可见。本文告诉你 GEO 是什么，以及如何起步。',
    },
    cta: true,
  },
  {
    ...
    excerpt: {
      ...
      zh: 'AI Agent 通过 llms.txt 了解你的店铺卖什么，通过 agent.json 获取品牌身份、商品目录结构和引用偏好。没有这两个文件的店铺会被直接跳过。本文教你如何在 5 分钟内完成配置。',
    },
    cta: true,
  },
]
...
export default function BlogPage() {
  ...
  return (
    <div className="min-h-screen bg-canvas">
      ...
      <section className="relative overflow-hidden border-b border-[#1f1f1f] bg-[#090909] pb-16 pt-28">
        ...
        <div className="absolute left-1/2 top-0 h-72 w-[560px] -translate-x-1/2 bg-[rgba(241,90,43,0.10)] blur-[110px] pointer-events-none" />
        ...
        <div className="relative z-10 max-w-3xl mx-auto px-6 text-center">
          ...
          <h1 className="mb-5 font-serif text-4xl font-normal leading-[1.02] text-white md:text-6xl lg:text-7xl">
            {isZh ? 'GEO 策略资料库' : 'Research, playbooks, and field notes'}
          </h1>
          <p className="max-w-xl mx-auto text-base leading-7 text-[#c7c7c7] md:text-lg">
            {isZh
              ? '一套关于 GEO 方法、实施细节和策略实践的资料库。'
              : 'A calmer library of GEO methods, implementation notes, and practical strategy for teams shipping in the open.'}
          </p>
        </div>
      </section>
          ...
          <div className="bg-sage-bg border border-sage/20 rounded-2xl px-6 py-5 flex flex-col sm:flex-row items-center justify-between gap-4">
            <div className="flex items-center gap-4">
              <div className="w-10 h-10 rounded-xl bg-surface flex items-center justify-center shadow-elevation-sm flex-shrink-0">
                <svg className="w-6 h-6 text-sage" viewBox="0 0 109 124" fill="currentColor" aria-hidden="true">
